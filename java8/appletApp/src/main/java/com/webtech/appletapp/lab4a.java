package com.webtech.appletapp;
/*
<applet code = lab4a.class width=600 height=600> </applet>
*/
import java.awt.*;
import java.applet.*;
import java.awt.event.*;
public class lab4a extends Applet implements ActionListener{
    TextField inp;
    ...
    public void init(){
		...
		operator[0]=new Button("/"); operator[1]=new Button("*");
		operator[2]=new Button("-"); operator[3]=new Button("+");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(ch>='0' && ch<='9'|| ch=='.') { 
        	if (!op.equals("")) num2 = num2 + button; 
        	else num1 = num1 + button;   
		    ...
		    if(!num1.equals("") && !num2.equals("")){
		    	...
		    	if(n2==0 && op.equals("/")){
		    		...
		    		if (op.equals("+")) temp = n1 + n2; 
		    		else if (op.equals("-")) temp = n1 - n2; 
		    		else if (op.equals("/")) temp = n1/n2; 
		    		else temp = n1*n2; 
        	...
        	if (op.equals("") || num2.equals(""))  op = button; 
        	else { 
				double temp;
				double n1=Double.parseDouble(num1);
				double n2=Double.parseDouble(num2);
