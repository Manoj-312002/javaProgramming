...
public class simpleApp extends javax.swing.JFrame {public Map<String , String> passwds = new HashMap<>();
    user us;
    public simpleApp() {
        us = new user();
        initComponents();
    ...
    private void initComponents() {
        ...
        jPasswordField1.setMargin(new java.awt.Insets(4, 4, 4, 4));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( passwds.containsKey(username) ){
            if( passw.equals( passwds.get( username ) ) ){
                jLabel3.setText("Login successful");
                new userview( username , us ).setVisible(true);
                jLabel3.setText("Enter username and password");
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(simpleApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
